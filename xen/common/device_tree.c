...
#if 1 //ndef EARLY_RAMOOPS_ADDRESS
        early_info.mem.bank[early_info.mem.nr_banks].start = start;
        early_info.mem.bank[early_info.mem.nr_banks].size = size;
#else
        // with 1:1 mapping for dom0
        early_info.mem.bank[early_info.mem.nr_banks].start = 0x60000000;//0x42000000;
        early_info.mem.bank[early_info.mem.nr_banks].size = 0x60000000;//0x7e000000;
#endif
