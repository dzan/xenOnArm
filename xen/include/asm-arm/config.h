...
#if 1 //switch between chromebook and arndale
# define EARLY_UART_ADDRESS 0x12c20000
#else
  /* Chromebook-specific: base address of ramoops */
#  define EARLY_RAMOOPS_ADDRESS 0x41f00000
#  define CONFIG_PAGEALLOC_MAX_ORDER 0xd
#endif // select chromebook or arndale
#endif
